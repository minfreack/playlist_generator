...
`,U=e.div`
position: relative;
`,C=({token:e,setArtist:r,setSongs:s})=>{const[o,l]=n.exports.useState(""),i=()=>{a.get(`https://api.spotify.com/v1/search?q=${o}&type=track&limit=20`,{headers:{Authorization:"Bearer "+e}}).then((e=>{s(e.data.tracks.items)})),a.get(`https://api.spotify.com/v1/search?q=${o}&type=artist&limit=20`,{headers:{Authorization:"Bearer "+e}}).then((e=>{r(e.data.artists.items)}))};return t.createElement(f,{variant:!0,direction:"column",align:"center",justify:"center",margin:"1rem 0"},t.createElement(v,null,"Selecciona por lo menos 1 artista, 1 canción y un género. ¡Esto nos ayudará a darnos una idea de qué es lo que te gusta!"),t.createElement(U,null,t.createElement($,{src:"/assets/search.0a4e8f5f.svg",width:30,onClick:i}),t.createElement(S,{onChange:e=>{e.preventDefault(),l(e.target.value)},onKeyDown:e=>{"Enter"==e.key&&i()},placeholder:"Escríbe un artista o canción...",width:"45rem",value:o})))};C.propTypes={token:r.string,setArtist:r.any,setSongs:r.any};const j=e.div`
background-color: #131313;
border-radius: .5rem;
padding: .5rem;
width: 22.5rem;
cursor: pointer;
`;const A=({name:e,images:r,id:a,artistUser:s,setArtistUser:o})=>{var l;const[i,c]=n.exports.useState(!1);return t.createElement(j,{className:`${i&&"active"}`,onClick:()=>{0==i?(c(!i),o([...s,a])):(c(!i),o((e=>{const t=e.slice();return t.splice(t.indexOf(a),1),t})))}},t.createElement(f,{direction:"row",align:"center",gap:"1rem"},t.createElement(h,{user:!0,src:null==(l=r[0])?void 0:l.url,width:40}),t.createElement(v,null,e)))};A.propTypes={name:r.string,images:r.array,id:r.string,artistUser:r.any,setArtistUser:r.func};const _=({name:e,album:r,id:a,songsUser:s,setSongsUser:o})=>{var l;const[i,c]=n.exports.useState(!1);return t.createElement(j,{className:`${i&&"active"}`,onClick:()=>{0==i?(c(!i),o([...s,a])):(c(!i),o((e=>{const t=e.slice();return t.splice(t.indexOf(a),1),t})))}},t.createElement(f,{direction:"row",align:"center",gap:"1rem"},t.createElement(h,{user:!0,src:null==(l=r.images[0])?void 0:l.url,width:40}),t.createElement(v,null,e)))};_.propTypes={name:r.string,album:r.any,id:r.string,songsUser:r.any,setSongsUser:r.func};const z=e.div`
background-color: #131313;
border-radius: .5rem;
padding: .5rem;
width: 45%;
